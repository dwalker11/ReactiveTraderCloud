import './styles/OpenFinChromeStyles.scss'
      ...
      <div className="openfin-chrome">
        <div className={headerClasses}>
          <div className="openfin-chrome__header-title">
            <span className="openfin-chrome__header-title-label">Adaptive&#39; Reactive Trader</span>
          </div>
          <div className="openfin-chrome__header-controls-container">
            <ul className="openfin-chrome__header-controls">
              {this.props.minimize ? (
                <li className="openfin-chrome__header-control">
                  <a onClick={() => this.props.minimize()}>
                    <i className="fa fa-minus fa-set-position" />
                  </a>
                </li>
              ) : null}
              {this.props.maximize ? (
                <li className="openfin-chrome__header-control">
                  <a onClick={() => this.props.maximize()}>
                    <i className="fa fa-square-o" />
                  </a>
                </li>
              ) : null}
              <li className="openfin-chrome__header-control openfin-chrome__header-control--close">
