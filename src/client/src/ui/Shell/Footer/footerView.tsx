...
const FooterView: React.SFC<FooterViewProps> = (props: FooterViewProps) => {
  ...
  return (
    <footer className={footerClasses}>
      ...
      <div className="footer__status-indicator-wrapper" onMouseOut={() => props.toggleStatusServices()} onMouseOver={() => props.toggleStatusServices()}>
