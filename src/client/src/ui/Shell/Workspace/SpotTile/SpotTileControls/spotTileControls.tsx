...
class SpotTileControls extends React.Component<SpotTileControlsProps, {}> {
  render() {
    ...
    return (
      <div className="spot-tile-controls">
        ...
        <i className="popout__undock spot-tile__icon--undock glyphicon glyphicon-log-out" onClick={() => undockTile()} />
      </div>
    )
  }
}

export default SpotTileControls
