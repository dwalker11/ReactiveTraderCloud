...
class TradeNotification extends React.Component<TradeNotificationProps, {}> {
  ...
  render() {
    ...
    const containerClassName = classnames('trade-notification', { 'trade-notification--rejected': notification.status === TradeStatus.Rejected })
    return (
      <div className={containerClassName}>
        <span className="trade-notification__trade-status">{notification.status}</span>
        <div className="trade-notification__summary-item--direction">{notification.direction}</div>
