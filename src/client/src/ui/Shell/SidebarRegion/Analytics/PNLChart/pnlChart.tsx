...
class PNLChart extends React.Component<PNLChartProps, {}> {
  ...
  render() {
    ...
    if (this.props.seriesData.length >= 0) {
      ...
      pnlChart = (
        <NVD3Chart ref="pnlChart" type="lineChart" datum={this.prepareDatum(seriesData)} options={options} height={240} configure={configurePnLChart} />
      )
    } else {
