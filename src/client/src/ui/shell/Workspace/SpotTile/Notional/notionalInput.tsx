import './styles/NotionalInputStyles.scss'
...
class NotionalInput extends React.Component<NotionalInputProps, {}> {
  ...
  inputIsAllowed(charCode: number) {
    // allow character codes before the Unit Separator to catch Shift, Backspace, etc
