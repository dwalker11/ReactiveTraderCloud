...
const SidebarRegionView: React.SFC<SidebarRegionViewProps> = (props: SidebarRegionViewProps) => {
  const buttonStyles = classnames(
    'sidebar-region__element-button glyphicon glyphicon-stats',
    (props.displayAnalytics && 'sidebar-region__element--active') || 'sidebar-region__element--inactive'
  )
...
export default SidebarRegionView
