...
import { ACTION_TYPES as REGIONS_ACTIONS } from '../regions'
import { ACTION_TYPES as TILE_ACTIONS, tileUndocked } from '../../SpotTile'
...
export function popoutEpic() {
  ...
  const popoutWindowEpic = (action$, store) => {
